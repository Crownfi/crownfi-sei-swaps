...
pub use cw20::{
	BalanceResponse, Cw20Coin, Cw20ExecuteMsg as ExecuteMsg, Cw20QueryMsg as QueryMsg, Logo, MinterResponse,
};
...
pub fn is_valid_symbol(symbol: &str) -> bool {
	...
	for byte in bytes.iter() {
		if (*byte != 45) && (*byte < 47 || *byte > 57) && (*byte < 65 || *byte > 90) && (*byte < 97 || *byte > 122) {
			return false;
		}
	}
	true
