...
use crate::querier::{query_all_balances, query_balance, query_pair_info, query_supply, query_token_balance};
...
fn test_asset() {
	...
	assert_eq!(
		native_token_asset.into_msg(Addr::unchecked("addr0000")).unwrap(),
...
fn test_decimal_checked_ops() {
	...
	assert!(Decimal::from_ratio(Uint128::MAX, Uint128::from(10u128.pow(18u32)))
