...
export class PoolPairContract extends ContractBase {
	...
	buildUpdateConfigIx(args: {"admin"?: Addr | null, "endorsed"?: boolean | null, "fee_receiver"?: Addr | null, "maker_fee_bps"?: number | null, "total_fee_bps"?: number | null} = {}, funds?: Coin[]): ExecuteInstruction {
		const msg = {"update_config": args} satisfies PoolPairExecuteMsg;
		return this.executeIx(msg, funds);
	}
	buildProvideLiquidityIx(args: {"receiver"?: Addr | null, "receiver_payload"?: Binary | null, "slippage_tolerance"?: Decimal | null} = {}, funds?: Coin[]): ExecuteInstruction {
		const msg = {"provide_liquidity": args} satisfies PoolPairExecuteMsg;
		return this.executeIx(msg, funds);
	}
	buildWithdrawLiquidityIx(args: {"receiver"?: Addr | null, "receiver_payload"?: Binary | null} = {}, funds?: Coin[]): ExecuteInstruction {
		const msg = {"withdraw_liquidity": args} satisfies PoolPairExecuteMsg;
		return this.executeIx(msg, funds);
	}
	buildWithdrawAndSplitLiquidityIx(args: {"left_coin_receiver"?: Addr | null, "left_coin_receiver_payload"?: Binary | null, "right_coin_receiver"?: Addr | null, "right_coin_receiver_payload"?: Binary | null} = {}, funds?: Coin[]): ExecuteInstruction {
		const msg = {"withdraw_and_split_liquidity": args} satisfies PoolPairExecuteMsg;
		return this.executeIx(msg, funds);
	}
	buildSwapIx(args: {"expected_result"?: Uint128 | null, "receiver"?: Addr | null, "receiver_payload"?: Binary | null, "slippage_tolerance"?: Decimal | null} = {}, funds?: Coin[]): ExecuteInstruction {
