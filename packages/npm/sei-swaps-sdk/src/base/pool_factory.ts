...
export class PoolFactoryContract extends ContractBase {
	...
	queryPairs(args: {"after"?: [string, string], "limit"?: number | null} = {}): Promise<ArrayOf_PoolFactoryCreatedPair> {
		const msg = {"pairs": args} satisfies PoolFactoryQueryMsg;
		return this.query(msg);
	}
	buildUpdateConfigIx(args: {"admin"?: Addr | null, "default_maker_fee_bps"?: number | null, "default_total_fee_bps"?: number | null, "fee_receiver"?: Addr | null, "pair_code_id"?: number | null, "permissionless_pool_cration"?: boolean | null} = {}, funds?: Coin[]): ExecuteInstruction {
		const msg = {"update_config": args} satisfies PoolFactoryExecuteMsg;
		return this.executeIx(msg, funds);
	}
	buildCreatePoolIx(args: {"initial_shares_receiver"?: Addr | null, "left_denom": string}, funds?: Coin[]): ExecuteInstruction {
		const msg = {"create_pool": args} satisfies PoolFactoryExecuteMsg;
		return this.executeIx(msg, funds);
	}
	buildUpdateFeesForPoolIx(args: {"maker_fee_bps"?: number | null, "pair": [string, string], "total_fee_bps"?: number | null}, funds?: Coin[]): ExecuteInstruction {
		const msg = {"update_fees_for_pool": args} satisfies PoolFactoryExecuteMsg;
		return this.executeIx(msg, funds);
	}
	buildUpdateGlobalConfigForPoolIx(args: {"after"?: [string, string], "limit"?: number | null} = {}, funds?: Coin[]): ExecuteInstruction {
