...
use cosmwasm_std::{
    attr, from_json, to_json_binary, Addr, Binary, CosmosMsg, Decimal, Decimal256, Deps, DepsMut, Env,
...
use crownfi_astro_common::asset::{
...
fn mint_liquidity_token_message(
    ...
    panic!("auto-stake has been removed");
