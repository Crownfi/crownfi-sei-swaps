...
use cosmwasm_std::{
    from_json, to_json_binary, Addr, Binary, Coin, ContractResult, Empty, OwnedDeps,
...
pub struct WasmMockQuerier {
    ...
    crownfi_astro_factory_querier: AstroportFactoryQuerier,
}
    ...
    fn handle_default(&self, msg: &Binary) -> QuerierResult {
        match from_json(&msg).unwrap() {
            QueryMsg::Pair { asset_infos } => {
                ...
                match self.crownfi_astro_factory_querier.pairs.get(&key) {
...
impl WasmMockQuerier {
    pub fn new(base: MockQuerier<Empty>) -> Self {
        WasmMockQuerier {
            ...
            crownfi_astro_factory_querier: AstroportFactoryQuerier::default(),
        }
    }
    ...
    pub fn with_crownfi_astro_pairs(&mut self, pairs: &[(&String, &String)]) {
        self.crownfi_astro_factory_querier = AstroportFactoryQuerier::new(pairs);
    }
}
